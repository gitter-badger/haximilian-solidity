/**
* @fileoverview Deploys all contracts under "state" to the blockchain using the default address.
...
const ExampleLinearStateMachine = artifacts.require("ExampleLinearStateMachine");

module.exports = function(deployer) {
  // Use deployer to execute migration tasks.
  deployer.deploy(ExampleLinearStateMachine);
};
